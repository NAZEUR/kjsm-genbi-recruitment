...
export default function Documentation() {
  const images = [
    { id: 1, url: "/documentasi1.jpeg", alt: "Refreshing KJSM", size: "md:col-span-2 md:row-span-2" },
    { id: 2, url: "/documentasi2.jpeg", alt: "Playtopia With KJSM", size: "md:col-span-1 md:row-span-1" },
    { id: 3, url: "/documentasi3.jpeg", alt: "Documentation with BPH KJSM 2025", size: "md:col-span-1 md:row-span-1" },
    { id: 4, url: "/documentasi4.jpeg", alt: "After Event", size: "md:col-span-2 md:row-span-1" },
  ];
