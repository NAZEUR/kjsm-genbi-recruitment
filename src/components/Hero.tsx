...
import { Plane, CalendarDays, Camera, Video, PenTool, Users, Mic, Star } from 'lucide-react';
            ...
            <div className="h-full flex flex-col">
              <div className="flex justify-between items-start mb-6 md:mb-8">
                <div className="flex items-center gap-2 sm:gap-3">
                  <img src="/Logo GenBI Biru.png" alt="Logo GenBI" className="h-8 sm:h-12 w-auto" />
                  <div>
